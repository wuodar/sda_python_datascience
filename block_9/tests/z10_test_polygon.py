import unittest
from block_9.tests.polygon import Polygon, Triangle
...
class TestTriangle(unittest.TestCase):
    ...
    def test_get_area(self):
        ...
        #Then:
        desired_area = 7
        self.assertEqual(desired_area, triangle_area, msg=f"The desired number of sides is {desired_area}, not {triangle_area}" )
